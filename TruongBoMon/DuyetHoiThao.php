...
<body style="font-family:Arial;">
	...
	<div class="container">
		<center style="margin-top:100px;">
			<p class="h1">Các hội thảo đang chờ duyệt</p>
		</center>	
		<div style="width:900px; height:350px; margin: 0 auto; font-size:30px; overflow-y: auto;">
			<center>
				<table class="table table-striped table-bordered table-hover" id="listHoiThao">
					<tr>
						...
						<th class="bg-info" style="text-align: center">Đồng ý</th>
						<th class="bg-info" style="text-align: center">Không đồng ý</th>
					</tr>
				</table>
			</center>
		</div>
	...
	<script type="text/javascript" src="js/DuyetHoiThao.js"></script>
