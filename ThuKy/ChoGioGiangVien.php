...
<body style="font-family:Arial;">
	...
	<div class="container" id="ds_HoiThao" style="display:show">
		<center style="margin-top:100px;">
			<p class="h1">Các hội thảo đã thực hiện</p>
		</center>	
			...
			<center>
				<table class="table table-striped table-bordered table-hover" id="listHoiThao">
					<tr>
						...
						<th class="bg-info" style="text-align: center">Số Số người hiện tại</th>
	...
	<div class="container" id="ds_GiangVien" style="display:none">
		<center style="margin-top:100px;">
			<p class="h1" id="lb_ds"></p>
		</center>	
		<div style="width:700px; height:350px; margin: 0 auto; font-size:30px; overflow-y: auto;">
			<center>
				<table class="table table-striped table-bordered table-hover" id="listGiangVien">
					<tr>
						<th class="bg-info" style="text-align: center">STT</th>
						<th class="bg-info" style="text-align: center">Tên giảng viên</th>
						<th class="bg-info" style="text-align: center">Số giờ nhận được</th>
						<th class="bg-info" style="text-align: center">submit</th>
					</tr>
				</table>
			</center>
		</div>
	...
	<script type="text/javascript" src="js/ChoGioGiangVien.js"></script>
</body>
</html>